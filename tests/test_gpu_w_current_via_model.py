...
if __name__ == '__main__':
    ...
    dataloader = DataLoader(dataset, batch_size=50, shuffle=False) #num_workers=num_workers, worker_init_fn=seed_worker,generator=worker_generator
    ...
    for i in tqdm(range(maxIter)):
        ...
        for i_batch, (input_batch, output_batch) in enumerate(dataloader):
            ...
            dxdt = derivative_multi_input(x_domain, input_batch)
